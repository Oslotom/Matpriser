...
import { normalizeStoreName } from '../utils/receiptUtils';
...
/**
 * ReceiptSummaryCard - Displays a summary of the store and total amount spent
 */
export const ReceiptSummaryCard: React.FC<StoreInfoCardProps> = ({ result, totalSpent }) => {
