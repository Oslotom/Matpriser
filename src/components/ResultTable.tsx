...
export const ResultTable: React.FC<ResultTableProps> = ({ result, expandedIdx, setExpandedIdx }) => {
        ...
        <table className="w-full text-left border-collapse min-w-[400px] table-fixed">
          ...
          <tbody className="divide-y divide-slate-50">
            {result.items.map((item, idx) => {
              ...
              // Diff is now between paid price and cheapest price
                              ...
                              <table className="w-full text-left border-collapse">
                                ...
                                <tbody className="divide-y divide-slate-50">
                                  {GROCERY_CHAINS.map(store => {
                                    ...
                                    // Calculate difference from receipt price
